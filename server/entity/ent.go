...
// UpdateState resends the entity's metadata to all viewers of the entity.
...
// PlayAction plays a world.EntityAction, such as a hurt or death animation, for all viewers of the entity.
